    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::model($entry, array('route' => array('list.update'))) !!}
                        {!! Form::hidden('list_id') !!}
                        {!! Form::hidden('id') !!}
                        ...
                        <div class="row col-12 m-0">
                            ...
                            {!! Form::text('priority', null, ['class' => 'w-100 form-control']) !!}
                        </div>
                        <div class="row col-12 m-0 pt-3 form-group">
                            ...
                            <span class="col-5 pl-1">
                            	{!! Form::select('status', $entry->getValidStatuses(), null, ['class'=>'w-100 form-control']) !!}
                            </span>
